...
{
 "use strict";
 var CellularAutomata,Client,SC$1,WebSharper,Obj,UI,Var$1,ListModel,List,T,Operators,Seq,Var,HtmlModule,attr,View,Unchecked,ConcreteVar,Snap,Storage,Enumerator,JavaScript,Pervasives,Doc,Client$1,Templates,Arrays,AttrProxy,JS,Concurrency,AttrModule,Abbrev,Fresh,ArrayStorage,EventTarget,Node,Collections,Dictionary,Object,Attrs,DomUtility,Numeric,T$1,Elt,Array,SC$2,HashSet,WindowOrWorkerGlobalScope,Docs,Scheduler,DynamicAttrNode,SC$3,DocElemNode,CharacterData,Updates,DictionaryUtil,Prepare,Slice,KeyCollection,An,Settings,Mailbox,SC$4,Attrs$1,Dyn,SC$5,Strings,Docs$1,RunState,NodeSet,Anims,SC$6,Queue,CT,CancellationTokenSource,AsyncBody,BindVar,String,CheckedInput,SC$7,SC$8,AppendList,HashSetUtil,Char,Easing,HashSet$1,DomNodes,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime,console,Date;
 CellularAutomata=Global.CellularAutomata=Global.CellularAutomata||{};
 Client=CellularAutomata.Client=CellularAutomata.Client||{};
 SC$1=Global.StartupCode$cellularAutomata$Client=Global.StartupCode$cellularAutomata$Client||{};
 ...
 SC$1.$cctor=function()
 {
  var trigger,lm,dimensions,a;
  SC$1.$cctor=Global.ignore;
  function _(b)
  {
   return b?1:0;
  }
  function createTriggered(x,y)
  {
   return function(t)
   {
    var maxX,maxY,tr,x$1;
    function a$1(trigger$1,counter)
    {
     if(trigger$1)
      if(counter<2||counter>3)
       tr.UpdateMaybe(function(x$2)
       {
        return!x$2?null:{
         $:1,
         $0:false
    ...
    maxX=t[0];
    maxY=t[1];
    tr=Var$1.Create$1(false);
    lm.Append([[x,y],tr.get_View()]);
    View.Sink(function($1)
    {
     return a$1($1[0],$1[1]);
    },(x$1=View.Bind(function(lms)
    {
     var north,south,west,east,northwest,northeast,southwest,southeast;
     function p(k,a$2)
     {
      return Unchecked.Equals(k,[x-1,y]);
     }
     function p$1(k,a$2)
     {
      return Unchecked.Equals(k,[x+1,y]);
     ...
     function p$2(k,a$2)
     {
      return Unchecked.Equals(k,[x,y-1]);
     }
     function p$3(k,a$2)
     {
      return Unchecked.Equals(k,[x,y+1]);
     ...
     function p$4(k,a$2)
     {
      return Unchecked.Equals(k,[x-1,y-1]);
     }
     function p$5(k,a$2)
     {
      return Unchecked.Equals(k,[x-1,y+1]);
     ...
     north=x===0?View.Const(false):(Seq.find(function($1)
     {
      return p($1[0],$1[1]);
     },lms))[1];
     south=x===maxX-1?View.Const(false):(Seq.find(function($1)
     {
      return p$1($1[0],$1[1]);
     },lms))[1];
     west=y===0?View.Const(false):(Seq.find(function($1)
     {
      return p$2($1[0],$1[1]);
     },lms))[1];
     east=y===maxY-1?View.Const(false):(Seq.find(function($1)
     {
      return p$3($1[0],$1[1]);
     },lms))[1];
     northwest=x===0||y===0?View.Const(false):(Seq.find(function($1)
     {
      return p$4($1[0],$1[1]);
     },lms))[1];
     northeast=x===0||y===maxY-1?View.Const(false):(Seq.find(function($1)
     {
      return p$5($1[0],$1[1]);
     },lms))[1];
     southwest=x===maxX-1||y===0?View.Const(false):(Seq.find(function($1)
     {
      return p$6($1[0],$1[1]);
     },lms))[1];
     southeast=x===maxX-1||y===maxY-1?View.Const(false):(Seq.find(function($1)
     {
      return p$7($1[0],$1[1]);
     },lms))[1];
     return View.Map2(function(x$2,y$1)
     {
      return x$2+y$1;
     },View.Map2(function(x$2,y$1)
     {
      return x$2+y$1;
     },View.Map2(function(x$2,y$1)
     {
      return _(x$2)+_(y$1);
     },north,south),View.Map2(function(x$2,y$1)
     {
      return _(x$2)+_(y$1);
     },east,west)),View.Map2(function(x$2,y$1)
     {
      return x$2+y$1;
     },View.Map2(function(x$2,y$1)
     {
      return _(x$2)+_(y$1);
     },northwest,southeast),View.Map2(function(x$2,y$1)
     {
      return _(x$2)+_(y$1);
     },northeast,southwest)));
    },lm.v),View.Map2(function(x$2,y$1)
    {
     return[x$2,y$1];
    },trigger.get_View(),x$1)));
    return Doc.Element("div",[AttrModule.Handler("click",function()
    {
     return function()
     {
      return tr.Update(function(v)
      {
       return!v;
      });
     };
    }),AttrModule.Dynamic("class",View.Map(function(x$2)
    {
     return x$2?"gol-box gol-triggered":"gol-box";
    },tr.get_View()))],[]);
   };
  }
  function createRow(x,y)
  {
   return function(t)
   {
    ...
    mX=t[0];
    mY=t[1];
    return List.init(y,function(i)
    {
     return(function($1)
     {
      return createTriggered($1[0],$1[1]);
     }([x,i]))([mX,mY]);
    });
   };
  }
  function createRows(x,y)
  {
   return List.init(y,function(i)
   {
    return Doc.Element("div",[AttrProxy.Create("class","gol-row")],(function($1)
    {
     return createRow($1[0],$1[1]);
    }([i,y]))([x,y]));
   });
  }
  ...
  {
   trigger.Update(function(v)
   {
    return!v;
   });
  })])]),(Templates.LoadLocalTemplates(""),Doc.RunById("main",a))))));
 };
